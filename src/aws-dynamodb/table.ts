import {
  ...
  AttributeType,
  StreamViewType,
  TableProps as BaseTableProperties,
...
export type MaterializeTableProps<
...
> extends BaseTable {
  ...
  public constructor(
    ...
    super(scope, id, properties as unknown as BaseTableProperties);
  }
}
